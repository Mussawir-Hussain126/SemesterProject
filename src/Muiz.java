...
public class Muiz implements ActionListener,Runnable {
    String[] questions = {
            "An object could be...",
    ...
    String[][] options = {
            {"Anything", "An Algorithm", "A data container", "Keyword","class"},
            {"Adding a number to int", "Assigning a multiplication", "Assigning a name to variable", "Assigning a value to a variable","NOT"},
            {"Integer", "try", "static", "new","catch"},
            {"Sun Microsystems", "Starbucks", "Alphabet", "Microsoft","not"},
            {"1989", "1996", "1972", "1492","not"},
            {"Apple", "Latte", "Oak", "Koffing","not"},
            {"Steve Jobs", "Bill Gates", "James Gosling", "Mark Zuckerburg","not"}
    ...
    char guess;
    char answer;
    Random random = new Random();  //it is used to generate a random number btw 0 to 7
    ...
    public Muiz() {
        ...
        buttonE.setFont(new Font("Ariel", Font.BOLD, 35));
        ...
        answer_labelE.setFont(new Font("Ariel", Font.PLAIN, 35));
        ...
        time_label.setFont(new Font("Ariel", Font.PLAIN, 16));
